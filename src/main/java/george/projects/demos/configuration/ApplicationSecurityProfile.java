...
public class ApplicationSecurityProfile {
	...
	public static final String CUSTOM_SECURITY_FILTER = "CUSTOM_SECURITY_FILTER";
	public static final String IN_MEMORY_AUTH_WITH_SPRING_SEC_CONTROLLER_LOGIN = "IN_MEMORY_AUTH_WITH_SPRING_SEC_CONTROLLER_LOGIN";
